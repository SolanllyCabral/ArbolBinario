...
namespace ArbolBinario
{
    class ArbolBinario
    {
        ...
        public ArbolBinario(Nodo_Arbol nueva_raiz)
        {
            Raiz = nueva_raiz;
        }
        ...
        //Funcion para buscar un nodo (valor) del Arbol Binario
        ...
        public void DibujarArbol(Graphics grafo, Font fuente, Brush Relleno, Brush RellenoFuente, Pen Lapiz, Brush encuentro)
        {
            ...
            Raiz.DibujarRamas(grafo, Lapiz);   //Bibuja los enlaces entre nodos
        ...
        //Funcion para resaltar un nodo si es que existe
        public void resaltar(Graphics grafo, Font fuente, Brush Relleno, Brush RellenoFuente, Pen Lapiz, Nodo_Arbol Raiz, int x)
        {
            Nodo_Arbol actual = Raiz;
            Brush entorno = Brushes.Blue;
